        ...
        <div class="bs-example" style="padding: 10px">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form method="post" action="{{ route('deals.import') }}" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Import Deals</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <input type="file" name="fileDeals" required="required">
                                </div>
                            </div>
